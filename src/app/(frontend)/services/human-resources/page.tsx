...
const _industry = 'human-resources'
const industryDisplayName = 'Human Resources'
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: `Specialized resume writing and career services for ${industryDisplayName} professionals. Complete career branding solutions tailored to help you advance in HR.`,
    openGraph: {
    ...
    alternates: { canonical: `https://www.prosumely.com/services/human-resources` },
  }
}
...
export default async function HumanResourcesServicesPage() {
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional resume writing services for human resources professionals
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <p className="text-gray-600 mb-4">Need help choosing the right service for your HR career?</p>
