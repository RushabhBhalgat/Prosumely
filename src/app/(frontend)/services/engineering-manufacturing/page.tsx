...
const _industry = 'engineering-manufacturing'
const industryDisplayName = 'Engineering & Manufacturing'
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: `Specialized resume writing and career services for ${industryDisplayName} professionals. Complete career branding solutions tailored to help you advance in engineering.`,
    openGraph: {
    ...
    alternates: {
      canonical: `https://www.prosumely.com/services/engineering-manufacturing`,
    },
  }
}
...
export default async function EngineeringManufacturingServicesPage() {
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Technical resume writing services for engineers and manufacturing professionals
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <p className="text-gray-600 mb-4">
            Need help choosing the right service for your engineering career?
          </p>
          <Link
            href="/contact"
            className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-full hover:from-blue-700 hover:to-cyan-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
