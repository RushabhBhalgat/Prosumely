...
const _industry = 'banking-financial-services-insurance'
const industryDisplayName = 'Banking, Financial Services & Insurance (BFSI)'
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: `Specialized resume writing and career services for ${industryDisplayName} professionals. Complete career branding solutions tailored to help you advance in BFSI.`,
    openGraph: {
    ...
    alternates: {
      canonical: `https://www.prosumely.com/services/banking-financial-services-insurance`,
    },
  }
}
      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-wrap justify-center gap-1.5 max-w-4xl mx-auto">
          {profiles.map((profile, index) => (
            <span
              key={index}
              className="inline-flex items-center px-2.5 py-1 bg-blue-50 text-blue-800 text-xs font-medium rounded-md border border-blue-200"
            >
...
export default async function BFSIServicesPage() {
      ...
      <div className="container mx-auto px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            This page is only available in limited services mode.
          </p>
          <Link
            href="/services"
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional resume writing services for banking, financial services, and insurance professionals
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 px-4 max-w-7xl mx-auto mb-12">
          {limitedServices.map((service) => {
            ...
            return (
              <div
                key={service.id}
                className="relative bg-white border rounded-xl shadow-sm hover:shadow-md transition-all duration-300 w-full max-w-sm min-w-[280px]"
              >
                {service.popular && (
        ...
        <div className="text-center mt-16">
          <p className="text-gray-600 mb-4">
            Need help choosing the right service for your BFSI career?
          </p>
          <Link
            href="/contact"
            className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-full hover:from-blue-700 hover:to-cyan-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
